  ...
  return (
    <div  name="contact" className="w-full h-screen bg-[#1b1188] flex justify-center items-center p-4">
      <form method="POST" action="https://getform.io/f/00f5d63f-97e3-4e26-82c3-4d3126d229a4" className="flex flex-col max-w-[600px] w-full">
        <div className="pb-8">
            <p className="text-4xl inline border-b-4 border-red-600 font-bold text-gray-300">Contact Me </p>
        ...
        <button className="py-3 px-4 my-8 mx-auto text-white border-2 flex items-center hover:bg-red-600 hover:border-red-600">Let's Work</button>
      </form>
    </div>
  );
}
